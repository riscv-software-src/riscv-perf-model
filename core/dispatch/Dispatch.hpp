...
namespace olympia
{
    ...
    class Dispatch : public sparta::Unit
    {
      ...
      private:
        ...
        enum StallReason : uint16_t
        {
            ...
            VMV_BUSY = InstArchInfo::TargetPipe::VMV,
            V2S_BUSY = InstArchInfo::TargetPipe::V2S,
            ...
            VPERMUTE_BUSY = InstArchInfo::TargetPipe::VPERMUTE,
        ...
        std::array<sparta::CycleCounter, N_STALL_REASONS> stall_counters_{
            {sparta::CycleCounter(getStatisticSet(), "stall_br_busy", "BR busy",
             ...
             sparta::CycleCounter(getStatisticSet(), "stall_vmask_busy", "VMASK busy",
                                  sparta::Counter::COUNT_NORMAL, getClock()),
             sparta::CycleCounter(getStatisticSet(), "stall_vmv_busy", "VMV busy",
                                  sparta::Counter::COUNT_NORMAL, getClock()),
             sparta::CycleCounter(getStatisticSet(), "stall_v2s_busy", "V2S busy",
                                  sparta::Counter::COUNT_NORMAL, getClock()),
             ...
             sparta::CycleCounter(getStatisticSet(), "stall_vfmul_busy", "VFMUL busy",
                                  sparta::Counter::COUNT_NORMAL, getClock()),
             sparta::CycleCounter(getStatisticSet(), "stall_vpermute_busy", "VPERMUTE busy",
                                  sparta::Counter::COUNT_NORMAL, getClock()),
             sparta::CycleCounter(getStatisticSet(), "stall_vload_busy", "VLOAD busy",
                                  sparta::Counter::COUNT_NORMAL, getClock()),
             sparta::CycleCounter(getStatisticSet(), "stall_vstore_busy", "VSTORE busy",
                                  sparta::Counter::COUNT_NORMAL, getClock()),
        ...
        std::array<sparta::Counter, InstArchInfo::N_TARGET_PIPES> unit_distribution_{
            {sparta::Counter(getStatisticSet(), "count_br_insts", "Total BR insts",
             ...
             sparta::Counter(getStatisticSet(), "count_vmask_insts", "Total VMASK insts",
                             sparta::Counter::COUNT_NORMAL),
             sparta::Counter(getStatisticSet(), "count_vmv_insts", "Total VMV insts",
                             sparta::Counter::COUNT_NORMAL),
             sparta::Counter(getStatisticSet(), "count_v2s_insts", "Total V2S insts",
                             sparta::Counter::COUNT_NORMAL),
             ...
             sparta::Counter(getStatisticSet(), "count_vfmul_insts", "Total VFMUL insts",
                             sparta::Counter::COUNT_NORMAL),
             sparta::Counter(getStatisticSet(), "count_vpermute_insts", "Total VPERMUTE insts",
                             sparta::Counter::COUNT_NORMAL),
             sparta::Counter(getStatisticSet(), "count_vload_insts", "Total VLOAD insts",
                             sparta::Counter::COUNT_NORMAL),
             sparta::Counter(getStatisticSet(), "count_vstore_insts", "Total VSTORE insts",
                             sparta::Counter::COUNT_NORMAL),
    ...
    inline std::ostream & operator<<(std::ostream & os, const Dispatch::StallReason & stall)
    {
        ...
        {
            os << InstArchInfo::execution_pipe_string_map.at((InstArchInfo::TargetPipe)stall)
               << "_BUSY";
        }
        else
        {
