...
namespace olympia
{
...

    {
      public:
        ...
        SimpleDL1(sparta::TreeNode* parent, uint64_t cache_size_kb, uint64_t line_size,
                  const sparta::cache::ReplacementIF & rep) :
            sparta::cache::SimpleCache2<SimpleCacheLine>(cache_size_kb, line_size, line_size,
                                                         SimpleCacheLine(line_size), rep),
