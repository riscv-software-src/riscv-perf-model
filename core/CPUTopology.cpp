...
olympia::CoreTopologySimple::CoreTopologySimple()
{
    ...
    units
        = {{"core*", "cpu", "Core *", sparta::TreeNode::GROUP_NAME_NONE,
    ...
    port_connections = {
        ...
        {"cpu.core*.dcache.ports.out_biu_req", "cpu.core*.biu.ports.in_biu_req"},
        {"cpu.core*.biu.ports.out_biu_ack", "cpu.core*.dcache.ports.in_biu_ack"},
        ...
        {"cpu.core*.rob.ports.out_retire_flush", "cpu.core*.flushmanager.ports.in_retire_flush"},
        ...
        {"cpu.core*.flushmanager.ports.out_retire_flush", "cpu.core*.rob.ports.in_reorder_flush"},
        {"cpu.core*.flushmanager.ports.out_retire_flush", "cpu.core*.lsu.ports.in_reorder_flush"},
...
void olympia::CoreTopologySimple::bindTree(sparta::RootTreeNode* root_node)
{
    ...
    {
        sparta::bind(
            root_node->getChildAs<sparta::Port>(left), root_node->getChildAs<sparta::Port>(right)
        );
    };
