...
namespace olympia
{
    ...
    class Inst
    {
      public:
         ...
         */
        Inst(
            const mavis::OpcodeInfo::PtrType & opcode_info,
        ...
        InstArchInfo::TargetUnit getUnit() const { return inst_arch_info_->getTargetUnit(); }
        ...
        const core_types::RegisterBitMask & getSrcRegisterBitMask(const core_types::RegFile rf
        ) const
        {
            return src_reg_bit_masks_[rf];
        }

        const core_types::RegisterBitMask & getDestRegisterBitMask(const core_types::RegFile rf
        ) const
        {
            return dest_reg_bit_masks_[rf];
        }

        const core_types::RegisterBitMask & getDataRegisterBitMask(const core_types::RegFile rf
        ) const
        {
            return store_data_mask_[rf];
        }
    ...
    class InstPairDef : public sparta::PairDefinition<Inst>
    {
      public:
        ...
        SPARTA_REGISTER_PAIRS(
            SPARTA_ADDPAIR("DID", &Inst::getUniqueID), SPARTA_ADDPAIR("uid", &Inst::getUniqueID),
