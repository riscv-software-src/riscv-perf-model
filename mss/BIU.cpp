...
namespace olympia_mss
{
        ...
        biu_latency_(p->biu_latency)
    {
        in_biu_req_.registerConsumerHandler
            (CREATE_SPARTA_HANDLER_WITH_DATA(BIU, getReqFromLSU_, olympia_core::Inst::InstPtr));
    ...
    void BIU::getReqFromLSU_(const olympia_core::Inst::InstPtr & inst_ptr)
    {
    ...
    void BIU::appendReqQueue_(const olympia_core::Inst::InstPtr& inst_ptr)
    {
