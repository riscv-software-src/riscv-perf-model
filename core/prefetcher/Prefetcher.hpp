#pragma once
#include "engines/PrefetchEngineIF.hpp"
...
namespace olympia
{
    ...
    class Prefetcher : public sparta::Unit, public PrefetcherIF<PrefetchEngineIF<>>
    {
      ...
      private:
        ...
        //! Restored via in_prefetcher_credits_ port when DCache completes a prefetch.
        ...
        //! Port to receive credits back from DCache
        sparta::DataInPort<uint32_t> in_prefetcher_credits_{&unit_port_set_,
                                                            "in_prefetcher_credits", 1};
        ...
        //! Handler for credits received from DCache
