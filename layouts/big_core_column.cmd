...
pipec	"ALU3 cred"	dispatch.in_alu3_credits
pipec	"ALU4 cred"	dispatch.in_alu4_credits
pipec	"ALU5 cred"	dispatch.in_alu5_credits
pipec	"BR0  cred"	dispatch.in_br0_credits
pipec	"BR1  cred"	dispatch.in_br1_credits
...
pipem	"ALU3 Sch"	execute.alu3.scheduler_queue.scheduler_queue		7	-1	4
pipeis	"ALU3 Sch"	execute.alu3.scheduler_queue.scheduler_queue		3	-1	0

pipem	"ALU4 Sch"	execute.alu4.scheduler_queue.scheduler_queue		7	-1	4
pipeis	"ALU4 Sch"	execute.alu4.scheduler_queue.scheduler_queue		3	-1	0

pipem	"ALU5 Sch"	execute.alu5.scheduler_queue.scheduler_queue		7	-1	4
pipeis	"ALU5 Sch"	execute.alu5.scheduler_queue.scheduler_queue		3	-1	0
...
pipem	"BR1 Sch"	execute.br1.scheduler_queue.scheduler_queue			7	-1	4
pipeis	"BR1 Sch"	execute.br1.scheduler_queue.scheduler_queue			3	-1	0
