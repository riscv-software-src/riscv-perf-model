...
namespace olympia
{
    ...
    class CPUFactory : public sparta::ResourceFactory<CPU, CPU::CPUParameterSet>
    {
      ...
      private:
         ...
         */
        auto buildTree_(sparta::RootTreeNode*, const std::vector<CPUTopology::UnitInfo> &) -> void;
        /**
         * @brief Implementation : Bind all the ports between different units and set TLBs and
         * preload
         */
        auto bindTree_(sparta::RootTreeNode*, const std::vector<CPUTopology::PortConnectionInfo> &)
            -> void;
