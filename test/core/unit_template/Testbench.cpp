...
private:
  void buildTree_() override
  {
    ...
    sparta::ResourceTreeNode* src_unit = new sparta::ResourceTreeNode(rtn,
                                    "src",
                                    sparta::TreeNode::GROUP_NAME_NONE,
                                    sparta::TreeNode::GROUP_IDX_NONE,
                                    "Source Unit",
...
//TODO should be able to do this through the opts vars
//     since this is boost prog opts under the covers
const char USAGE[] =
    "Usage:\n\n"
    "Testbench options \n"
