...
namespace olympia
{
    ...
    class ExecutePipe : public sparta::Unit
    {
      ...
      public:
        ...
        class ExecutePipeParameterSet : public sparta::ParameterSet
        {
          public:
            ...
            PARAMETER(
                bool, ignore_inst_execute_time, false,
      ...
      private:
        ...
        sparta::DataOutPort<uint32_t> out_scheduler_credits_{
            &unit_port_set_, "out_scheduler_credits"};
        ...
        sparta::collection::IterableCollector<std::list<InstPtr>> ready_queue_collector_{
        ...
        sparta::Counter total_insts_issued_{
            getStatisticSet(), "total_insts_issued", "Total instructions issued",
    ...
    using ExecutePipeFactory = sparta::ResourceFactory<
        olympia::ExecutePipe, olympia::ExecutePipe::ExecutePipeParameterSet>;
} // namespace olympia
