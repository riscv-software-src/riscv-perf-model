...
template <
    typename FusionGroupType, typename MachineInfoType,
...
struct Fusion
{
    ...
    //! \brief bare ctor
    Fusion() :
        Fusion({}, {}, {}, FusionGroupTypeAlloc(), MachineInfoTypeAlloc(),
               FieldExtractorType())
    {
    }
    ...
    //! \brief default fusion operator appends in to out and clears out.
