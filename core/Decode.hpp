...
namespace olympia
{
    ...
    class Decode : public sparta::Unit
    {
      ...
      private:
        ...
        sparta::DataInPort<InstGroupPtr> fetch_queue_write_in_{
            &unit_port_set_, "in_fetch_queue_write", 1};
        sparta::DataOutPort<uint32_t> fetch_queue_credits_outp_{
            &unit_port_set_, "out_fetch_queue_credits"};
        ...
        sparta::DataInPort<uint32_t> uop_queue_credits_in_{
            &unit_port_set_, "in_uop_queue_credits", sparta::SchedulingPhase::Tick, 0};
        ...
        sparta::UniqueEvent<> ev_decode_insts_event_{
            &unit_event_set_, "decode_insts_event", CREATE_SPARTA_HANDLER(Decode, decodeInsts_)};
