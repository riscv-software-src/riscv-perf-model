...
namespace olympia
{
    class LSU : public sparta::Unit
    {
      public:
        ...
        {
          public:
            // The modeler needs to alias a type called "SpartaPairDefinitionType" to the Pair
            ...
            LoadStoreInstInfo(const MemoryAccessInfoPtr & info_ptr)
                : mem_access_info_ptr_(info_ptr), rank_(IssuePriority::LOWEST),
            ...
            // This MemoryAccessInfo pointer will act as one of the two portals to the
            // MemoryAccesInfo class and we will use this pointer to query values from functions of
            // MemoryAccessInfo class
            ...
            bool winArb(const LoadStoreInstInfoPtr & that) const
            {
                ...
                return (
                    static_cast<uint32_t>(this->getPriority())
        ...
        /*!
         * \class LoadStoreInstInfoPairDef
         * \brief Pair Definition class of the load store instruction that flows through the
         * example/CoreModel
         */
        ...
        class LoadStoreInstInfoPairDef : public sparta::PairDefinition<LoadStoreInstInfo>
        {
          public:
            ...
            SPARTA_REGISTER_PAIRS(
                SPARTA_ADDPAIR("DID", &LoadStoreInstInfo::getInstUniqueID),
      ...
      private:
        ...
        sparta::UniqueEvent<> uev_issue_inst_{
            &unit_event_set_, "issue_inst", CREATE_SPARTA_HANDLER(LSU, issueInst_)};
        ...
        void updateIssuePriorityAfterTLBReload_(const InstPtr &, const bool = false);

        // Update issue priority after cache reload
        void updateIssuePriorityAfterCacheReload_(const InstPtr &, const bool = false);
        ...
        sparta::Counter lsu_insts_dispatched_{
            getStatisticSet(), "lsu_insts_dispatched", "Number of LSU instructions dispatched",
            sparta::Counter::COUNT_NORMAL};
        sparta::Counter stores_retired_{
            getStatisticSet(), "stores_retired", "Number of stores retired",
            sparta::Counter::COUNT_NORMAL};
        sparta::Counter lsu_insts_issued_{
            getStatisticSet(), "lsu_insts_issued", "Number of LSU instructions issued",
            sparta::Counter::COUNT_NORMAL};
        sparta::Counter lsu_insts_completed_{
            getStatisticSet(), "lsu_insts_completed", "Number of LSU instructions completed",
            sparta::Counter::COUNT_NORMAL};
        sparta::Counter lsu_flushes_{
            getStatisticSet(), "lsu_flushes", "Number of instruction flushes at LSU",
            sparta::Counter::COUNT_NORMAL};

        sparta::Counter biu_reqs_{
            getStatisticSet(), "biu_reqs", "Number of BIU reqs", sparta::Counter::COUNT_NORMAL};
    ...
    inline std::ostream &
    operator<<(std::ostream & os, const olympia::MemoryAccessInfo::MMUState & mmu_access_state)
    {
    ...
    inline std::ostream &
    operator<<(std::ostream & os, const olympia::LSU::LoadStoreInstInfo::IssuePriority & rank)
    {
        switch (rank)
        {
    ...
    inline std::ostream &
    operator<<(std::ostream & os, const olympia::LSU::LoadStoreInstInfo::IssueState & state)
    {
    ...
    inline std::ostream &
    operator<<(std::ostream & os, const olympia::LSU::LoadStoreInstInfo & ls_info)
    {
        os << "lsinfo: "
    ...
    inline std::ostream &
    operator<<(std::ostream & os, const olympia::LSU::LoadStoreInstInfoPtr & ls_info)
    {
        os << *ls_info;
        return os;
    }
    ...
    inline std::ostream &
    operator<<(std::ostream & os, const olympia::MemoryAccessInfoPtr & mem_ptr)
    {
        os << *mem_ptr;
        return os;
    }
