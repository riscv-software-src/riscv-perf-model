...
namespace olympia
{
    ...
    class MMU : public sparta::Unit
    {
      ...
      private:
        ...
        // Events
        ////////////////////////////////////////////////////////////////////////////////
        sparta::UniqueEvent<> uev_lookup_inst_{
            &unit_event_set_, "uev_lookup_inst", CREATE_SPARTA_HANDLER(MMU, lookupInst_), 1};

        // Counters
        sparta::Counter tlb_hits_{
            getStatisticSet(), "tlb_hits", "Number of TLB hits", sparta::Counter::COUNT_NORMAL};
        sparta::Counter tlb_misses_{
            getStatisticSet(), "tlb_misses", "Number of TLB misses", sparta::Counter::COUNT_NORMAL};
    };
} // namespace olympia